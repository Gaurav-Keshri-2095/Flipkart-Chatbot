...
from flipkart_bot.data_ingestion import data_ingestion
...
model = ChatGroq(groq_api_key = GROQ_API_KEY, model="llama3-70b-8192", temperature=0.5)
...
if __name__ == "__main__":
   ...
   answer1= conversational_rag_chain.invoke(
    ...
    config={
        "configurable": {"session_id": "Gaurav"}
    },  # constructs a key "abc123" in `store`.
)["answer"]
   print(answer1)